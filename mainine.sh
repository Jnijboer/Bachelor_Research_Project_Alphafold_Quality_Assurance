...
function help {
  echo "" 
  echo -e "\033[38;5;226mAutomated Workflow for Inner Mitochondrial Membrane Simulation Modeling\033[0m"   
...
/martini/delinyah/Project/OMM/insane -u POPC:2.9 -u POPE:3.6 -u PAPI:0.6 -u POPS:0.3 -u CDL1:2.6 -l POPC:5.8 -l POPE:3.7 -l PAPI:0.5 -l POPS:0.3 -l CDL1:1.1  -d 10 -o system.gro -f ${cg_pdb} -orient -center -pbc hex -sol W -salt 0 -excl -1 2>&1 | tee -a topol.top
